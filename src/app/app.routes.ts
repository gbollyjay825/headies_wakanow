...
export const routes: Routes = [
  ...
  { path: 'packages/:slug', loadComponent: () => import('./packages/package-details.component').then(m => m.PackageDetailsComponent), title: 'Travel Packages | The Headies x Wakanow' },
  ...
  { path: 'package_admin', loadComponent: () => import('./package-admin/package-admin-page.component').then(m => m.PackageAdminPageComponent), title: 'Package Dashboard | The Headies x Wakanow' },
  { path: '**', redirectTo: '' }
];
