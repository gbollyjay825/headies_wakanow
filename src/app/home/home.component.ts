...
export class HomeComponent {
  ...
  async submitTrip(valid: boolean | null): Promise<void> {
    ...
    const request: TravelRequest = {
      ...
      details: [
        ['Flight type', this.trip.flightType],
        ['Class of travel', this.trip.flightType === 'No Flight Needed' ? 'Not applicable' : this.trip.flightClass],
        ['Flight dates', this.dateRange(this.trip.flightDepartureDate, this.trip.flightReturnDate)],
        ['Accommodation', this.trip.accommodation],
        ['Hotel class', this.trip.accommodation === 'Hotel' ? this.trip.hotelClass : 'Not applicable'],
        ['Stay dates', this.dateRange(this.trip.hotelCheckIn, this.trip.hotelCheckOut)],
        ['Airport transfer', this.trip.airportTransfer],
        ['Transfer passengers', String(this.trip.transferPassengers || 1)],
        ['Transfer dates', this.dateRange(this.trip.arrivalTransferDate, this.trip.departureTransferDate)],
        ['Car rental', this.trip.carRentalNeeded ? this.trip.carType : 'Not added'],
        ['Car rental days', this.trip.carRentalNeeded ? String(this.trip.carRentalDays || 1) : 'Not applicable'],
        ['Car rental dates', this.trip.carRentalNeeded ? this.dateRange(this.trip.carPickupDate, this.trip.carReturnDate) : 'Not applicable'],
